...
#define S_FUNCTION_NAME QlearningPID
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      ActionNumOut
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      StateSeqAllOut
...
/* Output Port  3 */
#define OUT_PORT_3_NAME      errorStateOut
...
/* Output Port  4 */
#define OUT_PORT_4_NAME      errorIntegStateOut
...
/* Output Port  5 */
#define OUT_PORT_5_NAME      errorDiffStateOut
...
#define SOURCEFILES "__SFB__../src/PID.cpp__SFB__../src/RL_Brain.cpp"
#define PANELINDEX           6
...
extern void QlearningPID_Outputs_wrapper(const real_T *Ref,
			const real_T *Out,
			real_T *u0,
			real_T *ActionNumOut,
			...
			const real_T *xD);
extern void QlearningPID_Update_wrapper(const real_T *Ref,
			const real_T *Out,
			const real_T *u0,
...
{
    const real_T   *Ref  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *Out  = (const real_T*) ssGetInputPortSignal(S,1);
    real_T        *u0  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *ActionNumOut  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *StateSeqAllOut  = (real_T *)ssGetOutputPortRealSignal(S,2);
    real_T        *errorStateOut  = (real_T *)ssGetOutputPortRealSignal(S,3);
    real_T        *errorIntegStateOut  = (real_T *)ssGetOutputPortRealSignal(S,4);
    real_T        *errorDiffStateOut  = (real_T *)ssGetOutputPortRealSignal(S,5);
    const real_T   *xD = ssGetDiscStates(S);

    QlearningPID_Outputs_wrapper(Ref, Out, u0, ActionNumOut, StateSeqAllOut, errorStateOut, errorIntegStateOut, errorDiffStateOut, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    QlearningPID_Update_wrapper(Ref, Out, u0, ActionNumOut, StateSeqAllOut, errorStateOut, errorIntegStateOut, errorDiffStateOut,  xD);
}
